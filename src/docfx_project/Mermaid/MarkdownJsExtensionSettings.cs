...
namespace docfx_project.Mermaid
{
    /// <summary>
    ...
    public sealed record MarkdownJsExtensionSettings(PlaywrightRendererBrowserInstance BrowserSession, OutputMode OutputMode);
}
